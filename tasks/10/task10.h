...
#ifndef PRACTICE_2024_TASK10_H
#define PRACTICE_2024_TASK10_H
...
void task10(char *filename, char *keywords[], int num_keywords) {
...
void tests_task10() {
    char filename[] = "C:\\Users\\ivanu\\CLionProjects\\practice_2024\\tasks\\10\\books.txt";
    int num_keywords = 3;
    char *keywords[] = {"Algorithm", "Artificial", "Network"};

    task10(filename, keywords, num_keywords);
}

#endif //PRACTICE_2024_TASK10_H
